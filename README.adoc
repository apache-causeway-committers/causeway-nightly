...
Apache Isis Maven Artifacts::
  ...
  * available versions: link:https://repo.incode.work/org/apache/isis/isis-parent/maven-metadata.xml [version catalog (xml)]
Docker Images::
  * Demo app, published on Docker Hub as link:https://hub.docker.com/r/apacheisis/demo-springboot[apacheisis/demo-springboot], see https://github.com/apache/isis/tree/master/examples/demo[demo-sources] for details and on how to get started
